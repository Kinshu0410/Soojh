...
@app.on_message(filters.photo & (filters.private or filters.chat(chats=["POLLQZ",-1001132926651])))
...
@app.on_message(filters.document & (filters.private or filters.chat(chats=["POLLQZ",-1001132926651])))
