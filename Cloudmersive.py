...
app=Client("my_account",session_string="BQDQx-MAD62CGn-_l4hqeoG_F5jWwZKBiLMjGGPz69IGUFunjsJcgybjBcZFDdQrX7mq_7ezh_1hzEMgqURD1hCyuhkYzIpoObW6JbP1e9inD3ATkrp5wYRH8UjhIjOq0PRQyrca10-6UbdJA_44TiDTRcpDF6T8uEnXzMUbU5V9gxuZ7pkcVcEVJxURulRQUCa3JznNzeq3Rlsd58impGEPGSfdofoiPQU2_eVRFYDXaiUkoSDnDP19kzEOdgsaCvWDXoYNawdx1FHdQbnrN-OWZy3cXbg3TqXA7Odjgq1r3UGY0aUE0pK2ZmdGAdsasEcYcwGrt-9SrQrlykiwFLt4NZvbqwAAAAAqZYQtAA",api_id="13682659",api_hash="b984d240c5258407ea911f042c9d75f6")
		...
		if mid.poll:
			...
			for i in range(len(mess1.options)):
				if mess1.options[i].correct:
					...
					break
			try:
				await app.send_poll(chat_id=message.chat.id,question=mess1.poll.question,options=mess1.poll.options,correct_option_id =correct_option_id,reply_to_message=mess1.reply_to_message,is_anonymous=False,type=PollType.QUIZ,explanation=exp)
			except Exception as e:
				print("kinbin"+str(e))
