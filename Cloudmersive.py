...
import fitz, random
Admin = ["POLLQZ",711296045,"Sudhir_Parihar_Sahwa","reetpractice","MISSION_TEACHER_EXAM","Polls_quiz"]
@app.on_message(filters.regex("^.*$") &( filters.chat(chats=Admin)|filters.user(chats=Admin)))
