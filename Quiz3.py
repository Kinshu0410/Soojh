...
LIST_OF_ADMINS = ["711296045","1001183009","776365745","1527108544","2020953330","1202919365","1309577346","875026044","5094761615","786181993","1341437687","1353892576","5028705992","781968811","2111134423","1952288751","5259697190"]
    	...
    	for x in NewVar1:
    	    ...
    	    for y in range(len(NewVar2)):
    	        ...
    	        if y+1==len(NewVar2):
    	            ...
    	            context.bot.send_message(chat_id=update.message.chat.id,text="/start@Soojhboojh_01bot share_quiz"+cid1+"moum"+str(NewVar[1])+"moum"+str(zzz)+"moum"+str(int(zzz)+int(NewVar2[y])))
    	            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Share Quiz",url="tg://share?text=/start@Soojhboojh_01bot share_quiz"+cid1+"moum"+str(NewVar[1])+"moum"+str(zzz)+"moum"+str(int(zzz)+int(NewVar2[y])))]])
    	        else:
    	            explanation=None
    	            reply_markup=None
    	        try:
