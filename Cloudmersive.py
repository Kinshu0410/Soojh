...
app=Client("my_account",session_string="BQDQx-MAEWTsFOH0R67OM0VqQhI53ldqTcXBmlJKN-iCcdcPIT9sypufnREZbJsjD1wE_kFpmcityRjU9nDs3IwDXewjsBWEfRGxBhKrviTFPVNEzMM6ixluHqyL28XNoO3lg-_ScUS2ZDw54dHudyJ_je6W_3VZNubH14YzkM_50XCJAy0sAbQhcGUleEL4JtzYntfLQjuewnVK4uBgZbjuiIbobmiLJ_GOPjs7sG7GIUvRS-d_tFZEjaw5Zmu-CguQDDA5YJ6YZy0ejVP-r4CDLgrg2hgCqBLrXLJCAglC57Yam3qefa0xmoT2H5CUmmYTJnSke1mSv1w5LXP-IguQv3XgaAAAAAAqZYQtAA",api_id="13682659",api_hash="b984d240c5258407ea911f042c9d75f6")
        ...
        try:
            ...
            for page_num in pages:
                ...
                with open('{0}.pdf'.format(file_base_name), 'wb') as f:
                    pdfWriter.write(f)
            f.close()
            await app.send_document(message.chat.id, '{0}.pdf'.format(file_base_name))
            Drive_OCR(body).delete(id),
