...
@app.on_message(filters.regex("^Sup") )#& filters.chat(chats=["POLLQZ",-1001132926651])& filters.private)
...
@app.on_message(filters.regex("^Sub") )#& filters.chat(chats=["POLLQZ",-1001132926651])& filters.private)
