        ...
        for x in new_result:
            ...
            for y in new_result[x]:
                ...
                if zz==3:
                    ...
                    count=count+2
                zz-=1
                Text=reaaa.sub("([^\u0041-\u005a\u0061-\u007a\u0040\u0020\u0900-\u097F\u0030-\u0039])","", str(new_result[x][y]))
                body={"requests":[{"insertText":{"location":{"index":count},"text":reaaa.sub("([^\u0041-\u005a\u0061-\u007a\u0040\u0020\u0900-\u097F\u0030-\u0039])","", str(new_result[x][y]))},},],}
...
async def job2_partener2(client:Client,message:Message):
        ...
        for x in li:
            ...
            try:
            	...
            	lis=[]
            	Text=reaaa.sub("([^\u0041-\u005a\u0061-\u007a\u0040\u0020\u0900-\u097F\u0030-\u0039])","", "Q "+str(nn)+". "+question+"\n")
            	...
            	count=count+len(Text)
            	Drive_OCR(body).update(id)
            	mess2=(await app.send_poll(chat_id=message.chat.id,question=reaaa.sub("([^\u0041-\u005a\u0061-\u007a\u0040\u0020\u0900-\u097F\u0030-\u0039])","","Q "+str(int(xx[2])-nn+1)+". "+question),options=options,correct_option_id =correct_option_id,is_anonymous=False,type=PollType.QUIZ,open_period=tt1,explanation=explanation))
            	...
            	count=count+len(Text)
            	Drive_OCR(body).update(id)
            	Text=reaaa.sub("([^\u0041-\u005a\u0061-\u007a\u0040\u0020\u0900-\u097F\u0030-\u0039])","", explanation)
...
async def forword(client:Client,message:Message):
	...
	question=reaaa.sub("([^\u0041-\u005a\u0061-\u007a\u0040\u0020\u0900-\u097F\u0030-\u0039])","", mess.question)
