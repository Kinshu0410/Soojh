...
app=Client("my_account",session_string="BQDQx-MABZJOuzgP50MPemN2kYGQoYGDEofqEzZSEn_Vk8LtG8rMeG68zo9M2BINdFQwJaDfZPq7225OJSEKz-Kefy8xnxraDYQQok90Gi7VJIfvI4ML37TdBymBFR4I01h2Qjg1eXMjIwAVKh9oDtXYtaOPO4DTkNBwvF7_q9uVSXvoDKMrxJATXBqttCRB2uz7edS4VLztfbOPSn0WOT9-1bOEL1kHd_NImPRleIuudTbmrWDp9arwTpKL0elvcsXKyPl0Eaf0ZLwAZGEQVHqB5uNN3Puy10tlMHowBLHcOx78rmBLr9ipZfPK4P55Vibe6fDQ2cwb3pCgxatujDLPg-1WJQAAAAAqZYQtAA",api_id="13682659",api_hash="b984d240c5258407ea911f042c9d75f6")
...
async def job2_partener2(client:Client,message:Message):
        ...
        #Drive_OCR(body).update(id)
        try:
            replies=Drive_OCR({ "requests": [ { "updateDocumentStyle": { "documentStyle": { "background":{"color":{"color": {"rgbColor": {"red": 1,"green": 1,"blue": 1}}}},"marginTop": { "magnitude": 10, "unit": "PT" },"marginBottom": { "magnitude": 10, "unit": "PT" },"marginLeft": { "magnitude": 10, "unit": "PT" }, "marginRight": { "magnitude": 10, "unit": "PT" },"marginHeader": { "magnitude":10, "unit": "PT" },"marginFooter": { "magnitude": 10, "unit": "PT" },"pageSize": {"height":{"magnitude":(int(zzzz)+2)*11, "unit": "PT"},"width":{"magnitude": 180, "unit": "PT"}}}, "fields": "*" } }] } ).update(id)
